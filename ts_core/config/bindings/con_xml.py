...
# Generated 2018-02-11 21:00:18.803518 by PyXB version 1.2.6 using Python 3.6.3.final.0
...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier('urn:uuid:791ca98c-0f98-11e8-993f-186590d9922f')
...
class STD_ANON_11 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 17, 12)
    _Documentation = None
...
class STD_ANON_12 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 41, 12)
    _Documentation = None
STD_ANON_12._CF_pattern = pyxb.binding.facets.CF_pattern()
STD_ANON_12._CF_pattern.addPattern(pattern='.+->.+')
...
class STD_ANON_13 (pyxb.binding.datatypes.string):
    ...
    _ExpandedName = None
    _XSDLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 48, 12)
    _Documentation = None
STD_ANON_13._CF_pattern = pyxb.binding.facets.CF_pattern()
STD_ANON_13._CF_pattern.addPattern(pattern='.+->.+')
...
class deleteType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 56, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute from uses Python identifier from_
    __from = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'from'), 'from_', '__AbsentNamespace0_deleteType_from', pyxb.binding.datatypes.string, required=True)
    __from._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 57, 8)
    __from._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 57, 8)
    
    from_ = property(__from.value, __from.set, None, None)

    
    # Attribute to uses Python identifier to
    __to = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'to'), 'to', '__AbsentNamespace0_deleteType_to', pyxb.binding.datatypes.string)
    __to._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 58, 8)
    __to._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 58, 8)
    
    to = property(__to.value, __to.set, None, None)

    
    # Attribute fromLane uses Python identifier fromLane
    __fromLane = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'fromLane'), 'fromLane', '__AbsentNamespace0_deleteType_fromLane', pyxb.binding.datatypes.nonNegativeInteger)
    __fromLane._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 59, 8)
    __fromLane._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 59, 8)
    
    fromLane = property(__fromLane.value, __fromLane.set, None, None)

    
    # Attribute toLane uses Python identifier toLane
    __toLane = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'toLane'), 'toLane', '__AbsentNamespace0_deleteType_toLane', pyxb.binding.datatypes.nonNegativeInteger)
    __toLane._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 60, 8)
    __toLane._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 60, 8)
...
# Complex type connectionsType with content type ELEMENT_ONLY
class connectionsType (pyxb.binding.basis.complexTypeDefinition):
    """Complex type connectionsType with content type ELEMENT_ONLY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_ELEMENT_ONLY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'connectionsType')
    _XSDLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 8, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Element connection uses Python identifier connection
    __connection = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'connection'), 'connection', '__AbsentNamespace0_connectionsType_connection', True, pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 10, 12), )
    ...
    __prohibition = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'prohibition'), 'prohibition', '__AbsentNamespace0_connectionsType_prohibition', True, pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 11, 12), )
    ...
    __delete = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'delete'), 'delete', '__AbsentNamespace0_connectionsType_delete', True, pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 12, 12), )

    
    delete = property(__delete.value, __delete.set, None, None)

    
    # Element crossing uses Python identifier crossing
    __crossing = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'crossing'), 'crossing', '__AbsentNamespace0_connectionsType_crossing', True, pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 13, 12), )

    
    crossing = property(__crossing.value, __crossing.set, None, None)

    
    # Element walkingArea uses Python identifier walkingArea
    __walkingArea = pyxb.binding.content.ElementDeclaration(pyxb.namespace.ExpandedName(None, 'walkingArea'), 'walkingArea', '__AbsentNamespace0_connectionsType_walkingArea', True, pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 14, 12), )

    
    walkingArea = property(__walkingArea.value, __walkingArea.set, None, None)

    
    # Attribute version uses Python identifier version
    __version = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'version'), 'version', '__AbsentNamespace0_connectionsType_version', _module_typeBindings.STD_ANON_11)
    __version._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 16, 8)
    __version._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 16, 8)
    ...
    _ElementMap.update({
        ...
        __crossing.name() : __crossing,
        __walkingArea.name() : __walkingArea
    })
    _AttributeMap.update({
        __version.name() : __version
    })
_module_typeBindings.connectionsType = connectionsType
Namespace.addCategoryObject('typeBinding', 'connectionsType', connectionsType)
...
class connectionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 25, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __from._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 26, 8)
    __from._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 26, 8)
    
    from_ = property(__from.value, __from.set, None, None)

    
    # Attribute to uses Python identifier to
    __to = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'to'), 'to', '__AbsentNamespace0_connectionType_to', pyxb.binding.datatypes.string)
    __to._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 27, 8)
    __to._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 27, 8)
    
    to = property(__to.value, __to.set, None, None)

    
    # Attribute fromLane uses Python identifier fromLane
    __fromLane = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'fromLane'), 'fromLane', '__AbsentNamespace0_connectionType_fromLane', pyxb.binding.datatypes.nonNegativeInteger)
    __fromLane._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 28, 8)
    __fromLane._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 28, 8)
    
    fromLane = property(__fromLane.value, __fromLane.set, None, None)

    
    # Attribute toLane uses Python identifier toLane
    __toLane = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'toLane'), 'toLane', '__AbsentNamespace0_connectionType_toLane', pyxb.binding.datatypes.nonNegativeInteger)
    __toLane._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 29, 8)
    __toLane._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 29, 8)
    ...
    __pass._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 30, 8)
    __pass._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 30, 8)
    
    pass_ = property(__pass.value, __pass.set, None, None)

    
    # Attribute uncontrolled uses Python identifier uncontrolled
    __uncontrolled = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'uncontrolled'), 'uncontrolled', '__AbsentNamespace0_connectionType_uncontrolled', _module_typeBindings.boolType)
    __uncontrolled._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 31, 8)
    __uncontrolled._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 31, 8)
    
    uncontrolled = property(__uncontrolled.value, __uncontrolled.set, None, None)
    ...
    __keepClear._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 32, 8)
    __keepClear._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 32, 8)
    ...
    __contPos._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 33, 8)
    __contPos._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 33, 8)
    ...
    __visibility._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 34, 8)
    __visibility._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 34, 8)
    ...
    __speed._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 35, 8)
    __speed._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 35, 8)
    ...
    __shape._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 36, 8)
    __shape._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 36, 8)
    ...
    _AttributeMap.update({
        ...
        __toLane.name() : __toLane,
        __pass.name() : __pass,
        __uncontrolled.name() : __uncontrolled,
        __keepClear.name() : __keepClear,
...
class prohibitionType (pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 39, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute prohibitor uses Python identifier prohibitor
    __prohibitor = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'prohibitor'), 'prohibitor', '__AbsentNamespace0_prohibitionType_prohibitor', _module_typeBindings.STD_ANON_12, required=True)
    __prohibitor._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 40, 8)
    __prohibitor._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 40, 8)
    
    prohibitor = property(__prohibitor.value, __prohibitor.set, None, None)

    
    # Attribute prohibited uses Python identifier prohibited
    __prohibited = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'prohibited'), 'prohibited', '__AbsentNamespace0_prohibitionType_prohibited', _module_typeBindings.STD_ANON_13, required=True)
    __prohibited._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 47, 8)
    __prohibited._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 47, 8)
...
# Complex type crossingType with content type EMPTY
class crossingType (pyxb.binding.basis.complexTypeDefinition):
    """Complex type crossingType with content type EMPTY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_EMPTY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'crossingType')
    _XSDLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 63, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute node uses Python identifier node
    __node = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'node'), 'node', '__AbsentNamespace0_crossingType_node', pyxb.binding.datatypes.string, required=True)
    __node._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 64, 8)
    __node._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 64, 8)
    
    node = property(__node.value, __node.set, None, None)

    
    # Attribute edges uses Python identifier edges
    __edges = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'edges'), 'edges', '__AbsentNamespace0_crossingType_edges', pyxb.binding.datatypes.string)
    __edges._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 65, 8)
    __edges._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 65, 8)
    
    edges = property(__edges.value, __edges.set, None, None)

    
    # Attribute priority uses Python identifier priority
    __priority = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'priority'), 'priority', '__AbsentNamespace0_crossingType_priority', pyxb.binding.datatypes.int)
    __priority._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 66, 8)
    __priority._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 66, 8)
    
    priority = property(__priority.value, __priority.set, None, None)

    
    # Attribute width uses Python identifier width
    __width = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'width'), 'width', '__AbsentNamespace0_crossingType_width', _module_typeBindings.positiveFloatType)
    __width._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 67, 8)
    __width._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 67, 8)
    
    width = property(__width.value, __width.set, None, None)

    
    # Attribute discard uses Python identifier discard
    __discard = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'discard'), 'discard', '__AbsentNamespace0_crossingType_discard', _module_typeBindings.boolType)
    __discard._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 68, 8)
    __discard._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 68, 8)
    
    discard = property(__discard.value, __discard.set, None, None)

    
    # Attribute shape uses Python identifier shape
    __shape = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'shape'), 'shape', '__AbsentNamespace0_crossingType_shape', _module_typeBindings.shapeType)
    __shape._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 69, 8)
    __shape._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 69, 8)
    
    shape = property(__shape.value, __shape.set, None, None)

    
    # Attribute linkIndex uses Python identifier linkIndex
    __linkIndex = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'linkIndex'), 'linkIndex', '__AbsentNamespace0_crossingType_linkIndex', pyxb.binding.datatypes.integer)
    __linkIndex._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 70, 8)
    __linkIndex._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 70, 8)
...
_module_typeBindings.crossingType = crossingType
Namespace.addCategoryObject('typeBinding', 'crossingType', crossingType)


# Complex type walkingAreaType with content type EMPTY
class walkingAreaType (pyxb.binding.basis.complexTypeDefinition):
    """Complex type walkingAreaType with content type EMPTY"""
    _TypeDefinition = None
    _ContentTypeTag = pyxb.binding.basis.complexTypeDefinition._CT_EMPTY
    _Abstract = False
    _ExpandedName = pyxb.namespace.ExpandedName(Namespace, 'walkingAreaType')
    _XSDLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 73, 4)
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    
    # Attribute node uses Python identifier node
    __node = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'node'), 'node', '__AbsentNamespace0_walkingAreaType_node', pyxb.binding.datatypes.string, required=True)
    __node._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 74, 8)
    __node._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 74, 8)
    
    node = property(__node.value, __node.set, None, None)

    
    # Attribute edges uses Python identifier edges
    __edges = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'edges'), 'edges', '__AbsentNamespace0_walkingAreaType_edges', pyxb.binding.datatypes.string)
    __edges._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 75, 8)
    __edges._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 75, 8)
    
    edges = property(__edges.value, __edges.set, None, None)

    
    # Attribute shape uses Python identifier shape
    __shape = pyxb.binding.content.AttributeUse(pyxb.namespace.ExpandedName(None, 'shape'), 'shape', '__AbsentNamespace0_walkingAreaType_shape', _module_typeBindings.shapeType)
    __shape._DeclarationLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 76, 8)
    __shape._UseLocation = pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 76, 8)
...
_module_typeBindings.walkingAreaType = walkingAreaType
Namespace.addCategoryObject('typeBinding', 'walkingAreaType', walkingAreaType)


connections = pyxb.binding.basis.element(pyxb.namespace.ExpandedName(Namespace, 'connections'), connectionsType, location=pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 6, 4))
...
connectionsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'connection'), connectionType, scope=connectionsType, location=pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 10, 12)))

connectionsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'prohibition'), prohibitionType, scope=connectionsType, location=pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 11, 12)))

connectionsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'delete'), deleteType, scope=connectionsType, location=pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 12, 12)))

connectionsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'crossing'), crossingType, scope=connectionsType, location=pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 13, 12)))

connectionsType._AddElement(pyxb.binding.basis.element(pyxb.namespace.ExpandedName(None, 'walkingArea'), walkingAreaType, scope=connectionsType, location=pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 14, 12)))
...
def _BuildAutomaton_2 ():
    ...
    counters = set()
    cc_0 = fac.CounterCondition(min=0, max=None, metadata=pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 9, 8))
    counters.add(cc_0)
    states = []
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(connectionsType._UseForTag(pyxb.namespace.ExpandedName(None, 'connection')), pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 10, 12))
    st_0 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_0)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(connectionsType._UseForTag(pyxb.namespace.ExpandedName(None, 'prohibition')), pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 11, 12))
    st_1 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_1)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(connectionsType._UseForTag(pyxb.namespace.ExpandedName(None, 'delete')), pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 12, 12))
    st_2 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_2)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(connectionsType._UseForTag(pyxb.namespace.ExpandedName(None, 'crossing')), pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 13, 12))
    st_3 = fac.State(symbol, is_initial=True, final_update=final_update, is_unordered_catenation=False)
    states.append(st_3)
    final_update = set()
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(connectionsType._UseForTag(pyxb.namespace.ExpandedName(None, 'walkingArea')), pyxb.utils.utility.Location('http://sumo.dlr.de/xsd/connections_file.xsd', 14, 12))
    ...
    return fac.Automaton(states, counters, True, containing_state=None)
connectionsType._Automaton = _BuildAutomaton_2()
